...
DEMO_SEARCH_CANDIDATES = [
    ...
    },
    {
        ...
        "tech_stack": ["Python", "LangChain", "Gemini", "PostgreSQL", "pgvector"],
        "skills": ["Machine Learning", "Embeddings", "Vector Search", "Python", "Prompt Engineering"],
        "verified_score": 84,
        "ai_test_score": 83,
        "project_quality_score": 81,
        "communication_score": 78,
        "role_fit": 89,
        "summary": "AI/ML candidate with embedding search, LLM orchestration, and Python evidence.",
    },
    {
        "slug": "systems-debugging",
        "email": "demo.systems@xlr8hire.demo",
        "full_name": "Ayesha Malik",
        "target_role": "Systems Debugging Engineer",
        "tech_stack": ["PostgreSQL", "Docker", "FastAPI", "Observability"],
        "skills": ["Debugging", "Performance", "Databases", "Distributed Systems", "Testing"],
        "verified_score": 82,
        "ai_test_score": 81,
        "project_quality_score": 78,
        "communication_score": 85,
        "role_fit": 86,
        "summary": "Candidate with strong debugging, database reasoning, and production failure analysis.",
    },
]
